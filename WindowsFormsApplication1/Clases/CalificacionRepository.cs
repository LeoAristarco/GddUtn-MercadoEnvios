...
namespace WindowsFormsApplication1.Calificar
{
    internal class CalificacionRepository : Repository
    {
        ...
        {
            string update = "update CHAR_DE_30.CALIFICACION set calif_estrellas=" + calificacion.estrellas.ToString() + ", "
        ...
        {
            string consulta = "select * from CHAR_DE_30.CALIFICACION where id_calificacion=" + v.ToString();
        ...
        internal List<long> obtenerResumenCalificaciones(Usuario usuario)
        {
            ...
            List<Dictionary<string, object>> tabla = db.ejecutarStoredProcedure("CHAR_DE_30.st_resumenDeEstrellasDadas", parametros);
