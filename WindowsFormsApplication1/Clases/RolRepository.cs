...
namespace WindowsFormsApplication1.ABM_Rol
{
    internal class RolRepository : Repository
    {
        public List<Rol> obtenerRolesDe(Usuario usuario)
        {
            ...
            string procedimiento = "CHAR_DE_30.OBTENER_ROLES_POR_ID_USUARIO";
        ...
        public List<Rol> TodosLosRolesDelSistema()
        {
            ...
            string sql = "select * from CHAR_DE_30.ROL";
        ...
        public List<Usuario> cargarUsuariosDelSistema()
        {
            ...
            string procedimiento = "CHAR_DE_30.OBTENER_USUARIOS_PARA_ABM_ROL";
        ...
        public void actualizarRolPorUsuario(Usuario user, List<Rol> rolesActualizados)
        {
            ...
            {
                string procedimiento = "CHAR_DE_30.ACTUALIZAR_ROL_POR_USUARIO";
        ...
        public List<Funcionalidad> obtenerTodasLasFuncionalidades()
        {
            ...
            string sql = "select * from CHAR_DE_30.FUNCIONALIDAD";
        ...
        public List<Funcionalidad> obtenerLasFuncionalidadesDel(Rol rol)
        {
            ...
            string procedimiento = "CHAR_DE_30.OBTENER_FUNCIONALIDADES_DEL_ROL";
        ...
        {
            //inserto nuevo rol
            string procedimiento = "CHAR_DE_30.INSERTAR_NUEVO_ROL";
            ...
            string sql = "select id_rol from CHAR_DE_30.ROL where rol_nombre = '" + rol.nombre+"'";
            ...
            {
                string procedimiento2 = "CHAR_DE_30.ACTUALIZAR_FUNCIONALIDADES_DE_ROL";
        ...
        {
            //actualizo el rol
            string procedimiento2 = "CHAR_DE_30.ACTUALIZAR_ROL";
            ...
            foreach (Funcionalidad fun in funcionalidades)
            {
                string procedimiento = "CHAR_DE_30.ACTUALIZAR_FUNCIONALIDADES_DE_ROL";
